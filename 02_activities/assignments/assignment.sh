...
find ./data/raw -type f -name "*ipaddr*" -exec git rm -f --ignore-unmatch {} +
find ./data/processed/user_logs -type f -name "*ipaddr*" -exec git rm -f --ignore-unmatch {} +
